...
public class MasterServer {
    ...
    public static void main(String[] args) throws IOException, YarnException {
        ...
        YarnClient yarnClient = new YarnClient(yarnConfiguration);
         ...
         */
        StormThriftService.Iface handler = new StormThriftServiceImpl(floodContrJobPubProxy);


        FloodContrMaster floodContrMaster = new FloodContrMaster(yarnClient,new StormThriftService.Processor<>(handler), 9000) {
            /**
